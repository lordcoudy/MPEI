...
begin
    ...
    begin
      ...
      if (M1 = 0) and (M2 = 0) then
              writeln(fout,'M1 = ',M1:2,' M2 = ',M2:2,' Так как M1 и M2 равны 0, то невозможно найти C1 и C2')
              else if M2 = 0 then
              writeln(fout,'M1 = ',M1:2,' Так как М1 равно 0, то невозможно найти С1 ','M2 = ',M2:2,', C2 = ',C2:5)
              else if M1 = 0 then
              writeln(fout,'M1 = ',M1:2,', C1 = ',C1:5,' M2 = ',M2:2,' Так как М2 равно 0, то невозможно найти С2 ')
              else
