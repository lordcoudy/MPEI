...
function ReadFileEx(hFile: THandle; lpBuffer: Pointer; nNumberOfBytesToRead: DWORD;
  lpOverlapped: POverlapped; lpCompletionRoutine: FARPROC): BOOL; stdcall;
...
function SearchPathA(lpPath, lpFileName, lpExtension: PAnsiChar;
  nBufferLength: DWORD; lpBuffer: PAnsiChar; const lpFilePart: PAnsiChar): DWORD; stdcall;
function SearchPathW(lpPath, lpFileName, lpExtension: PWideChar;
  nBufferLength: DWORD; lpBuffer: PWideChar; const lpFilePart: PWideChar): DWORD; stdcall;
function SearchPath(lpPath, lpFileName, lpExtension: PChar;
  nBufferLength: DWORD; lpBuffer: PChar; const lpFilePart: PChar): DWORD; stdcall;
...
function ReportEventA(hEventLog: THandle; wType, wCategory: Word;
  ...
  dwDataSize: DWORD; var lpStrings: PAnsiChar; lpRawData: Pointer): BOOL; stdcall;
function ReportEventW(hEventLog: THandle; wType, wCategory: Word;
  dwEventID: DWORD; lpUserSid: Pointer; wNumStrings: Word;
  dwDataSize: DWORD; var lpStrings: PWideChar; lpRawData: Pointer): BOOL; stdcall;
function ReportEvent(hEventLog: THandle; wType, wCategory: Word;
  dwEventID: DWORD; lpUserSid: Pointer; wNumStrings: Word;
  dwDataSize: DWORD; var lpStrings: PChar; lpRawData: Pointer): BOOL; stdcall;
...
function OpenThreadToken(ThreadHandle: THandle; DesiredAccess: DWORD;
  OpenAsSelf: BOOL; TokenHandle: PHandle): BOOL; stdcall;
...
{ Win32 Spooler Error Codes }
  ...
  ERROR_PRINT_PROCESSOR_ALREADY_IN = 3005;

  { The specified print monitor has already been installed. }
  ERROR_PRINT_MONITOR_ALREADY_INST = 3006;
...
const
  DM_SPECVERSION = $400;  { current version of specification }
...
type
  ...
  TOutlineTextmetricA = packed record
    otmSize: UINT;
  ...
  TOutlineTextmetricW = packed record
    otmSize: UINT;
    otmTextMetrics: TTextMetric;
    otmFiller: Byte;
    otmPanoseNumber: TPanose;
...
function GetCharacterPlacement(DC: HDC; p2: PChar; p3, p4: BOOL;
  var p5: TGCPResults; p6: DWORD): DWORD; stdcall;
function GetViewportExtEx(DC: HDC; var p2: TSize): BOOL; stdcall;
function GetViewportOrgEx(DC: HDC; Point: PPoint): BOOL; stdcall;
function GetWindowExtEx(DC: HDC; var p2: TSize): BOOL; stdcall;
function GetWindowOrgEx(DC: HDC; var p2: TPoint): BOOL; stdcall;
...
type
  ...
  TDIBSection = packed record
    ...
    dsBitfields: array[0..3] of DWORD;
    dshSection: THandle;
    dsOffset: DWORD;
  end;
...
function SetBrushOrgEx(DC: HDC; X, Y: Integer; var Points): BOOL; stdcall;
...
function GetICMProfileA(DC: HDC; Size: DWORD; Name: PAnsiChar): BOOL; stdcall;
function GetICMProfileW(DC: HDC; Size: DWORD; Name: PWideChar): BOOL; stdcall;
function GetICMProfile(DC: HDC; Size: DWORD; Name: PChar): BOOL; stdcall;
...
function UpdateICMRegKeyA(p1, p2: DWORD; p3: PAnsiChar; p4: UINT): BOOL; stdcall;
function UpdateICMRegKeyW(p1, p2: DWORD; p3: PWideChar; p4: UINT): BOOL; stdcall;
function UpdateICMRegKey(p1, p2: DWORD; p3: PChar; p4: UINT): BOOL; stdcall;
...
type
  ...
  TEMRExtSelectClipRgn = packed record
    emr: TEMR;
    cbRgnData: DWORD; { Size of region data in bytes}
    iMode: DWORD;
    RgnData: array[0..0] of Byte;
...
procedure mouse_event(dwFlags, dx, dy, cButtons, dwExtraInfo: DWORD); stdcall;
...
function GetUpdateRgn(hWnd: HWND; hRgn: HRGN; bErase: BOOL): BOOL; stdcall;
...
function ExcludeUpdateRgn(hDC: HDC; hWnd: HWND): BOOL; stdcall;
...
type
  ...
  TMultiKeyHelpA = packed record
    mkSize: DWORD;
    mkKeylist: AnsiChar;
    szKeyphrase: array[0..1] of AnsiChar;
  end;
  TMultiKeyHelpW = packed record
    mkSize: DWORD;
    mkKeylist: WideChar;
    szKeyphrase: array[0..1] of WideChar;
  end;
  ...
  THelpWinInfoA = packed record
    ...
    dy: BOOL;
    wMax: BOOL;
    rgchMember: array[0..2] of AnsiChar;
  end;
  THelpWinInfoW = packed record
    wStructSize: BOOL;
    x: BOOL;
    y: BOOL;
    dx: BOOL;
    dy: BOOL;
    wMax: BOOL;
    rgchMember: array[0..2] of WideChar;
  end;
...
{ Locale Dependent Mapping Flags. }
  ...
  LCMAP_LOWERCASE = $100; { lower case letters }
  LCMAP_UPPERCASE = $200; { upper case letters }
  LCMAP_SORTKEY = $400; { WC sort key (normalize) }
  LCMAP_BYTEREV = $800; { byte reversal }
...
{ LOCALE_NOUSEROVERRIDE is also used in GetTimeFormatW and GetDateFormatW. }
  ...
  LOCALE_ILANGUAGE = 1; { language id }
  LOCALE_SLANGUAGE = 2; { localized name of language }
  LOCALE_SENGLANGUAGE = 4097; { English name of language }
  LOCALE_SABBREVLANGNAME = 3; { abbreviated language name }
  LOCALE_SNATIVELANGNAME = 4; { native name of language }
  LOCALE_ICOUNTRY = 5; { country code }
  LOCALE_SCOUNTRY = 6; { localized name of country }
  LOCALE_SENGCOUNTRY = 4098; { English name of country }
  LOCALE_SABBREVCTRYNAME = 7; { abbreviated country name }
  LOCALE_SNATIVECTRYNAME = 8; { native name of country }
  LOCALE_IDEFAULTLANGUAGE = 9; { default language id }
  LOCALE_IDEFAULTCOUNTRY = 10; { default country code }
  LOCALE_IDEFAULTCODEPAGE = 11; { default code page }
  ...
  LOCALE_SGROUPING = $10; { digit grouping }
  ...
  LOCALE_SINTLSYMBOL = 21; { intl monetary symbol }
  LOCALE_SMONDECIMALSEP = 22; { monetary decimal separator }
  LOCALE_SMONTHOUSANDSEP = 23; { monetary thousand separator }
  LOCALE_SMONGROUPING = 24; { monetary grouping }
  LOCALE_ICURRDIGITS = 25; { # local monetary digits }
  LOCALE_IINTLCURRDIGITS = 26; { # intl monetary digits }
  ...
  LOCALE_IDATE = 33; { short date format ordering }
  LOCALE_ILDATE = 34; { long date format ordering }
  LOCALE_ITIME = 35; { time format specifier }
  LOCALE_ICENTURY = 36; { century format specifier }
  LOCALE_ITLZERO = 37; { leading zeros in time field }
  LOCALE_IDAYLZERO = 38; { leading zeros in day field }
  LOCALE_IMONLZERO = 39; { leading zeros in month field }
  LOCALE_S1159 = 40; { AM designator }
  LOCALE_S2359 = 41; { PM designator }
  LOCALE_SDAYNAME1 = 42; { long name for Monday }
  LOCALE_SDAYNAME2 = 43; { long name for Tuesday }
  LOCALE_SDAYNAME3 = 44; { long name for Wednesday }
  LOCALE_SDAYNAME4 = 45; { long name for Thursday }
  LOCALE_SDAYNAME5 = 46; { long name for Friday }
  LOCALE_SDAYNAME6 = 47; { long name for Saturday }
  LOCALE_SDAYNAME7 = 48; { long name for Sunday }
  LOCALE_SABBREVDAYNAME1 = 49; { abbreviated name for Monday }
  LOCALE_SABBREVDAYNAME2 = 50; { abbreviated name for Tuesday }
  LOCALE_SABBREVDAYNAME3 = 51; { abbreviated name for Wednesday }
  LOCALE_SABBREVDAYNAME4 = 52; { abbreviated name for Thursday }
  LOCALE_SABBREVDAYNAME5 = 53; { abbreviated name for Friday }
  LOCALE_SABBREVDAYNAME6 = 54; { abbreviated name for Saturday }
  LOCALE_SABBREVDAYNAME7 = 55; { abbreviated name for Sunday }
  LOCALE_SMONTHNAME1 = 56; { long name for January }
  LOCALE_SMONTHNAME2 = 57; { long name for February }
  LOCALE_SMONTHNAME3 = 58; { long name for March }
  LOCALE_SMONTHNAME4 = 59; { long name for April }
  LOCALE_SMONTHNAME5 = 60; { long name for May }
  LOCALE_SMONTHNAME6 = 61; { long name for June }
  LOCALE_SMONTHNAME7 = 62; { long name for July }
  LOCALE_SMONTHNAME8 = 63; { long name for August }
  LOCALE_SMONTHNAME9 = $40; { long name for September }
  LOCALE_SMONTHNAME10 = 65; { long name for October }
  LOCALE_SMONTHNAME11 = 66; { long name for November }
  LOCALE_SMONTHNAME12 = 67; { long name for December }
  LOCALE_SABBREVMONTHNAME1 = 68; { abbreviated name for January }
  LOCALE_SABBREVMONTHNAME2 = 69; { abbreviated name for February }
  LOCALE_SABBREVMONTHNAME3 = 70; { abbreviated name for March }
  LOCALE_SABBREVMONTHNAME4 = 71; { abbreviated name for April }
  LOCALE_SABBREVMONTHNAME5 = 72; { abbreviated name for May }
  LOCALE_SABBREVMONTHNAME6 = 73; { abbreviated name for June }
  LOCALE_SABBREVMONTHNAME7 = 74; { abbreviated name for July }
  LOCALE_SABBREVMONTHNAME8 = 75; { abbreviated name for August }
  LOCALE_SABBREVMONTHNAME9 = 76; { abbreviated name for September }
  LOCALE_SABBREVMONTHNAME10 = 77; { abbreviated name for October }
  LOCALE_SABBREVMONTHNAME11 = 78; { abbreviated name for November }
  ...
  LOCALE_IPOSSIGNPOSN = 82; { positive sign position }
  LOCALE_INEGSIGNPOSN = 83; { negative sign position }
  LOCALE_IPOSSYMPRECEDES = 84; { mon sym precedes pos amt }
  LOCALE_IPOSSEPBYSPACE = 85; { mon sym sep by space from pos amt }
  LOCALE_INEGSYMPRECEDES = 86; { mon sym precedes neg amt }
  LOCALE_INEGSEPBYSPACE = 87; { mon sym sep by space from neg amt }
...
{ Network Resources. }
  ...
  RESOURCEUSAGE_ALL = (RESOURCEUSAGE_CONNECTABLE or RESOURCEUSAGE_CONTAINER);
...
{ Network Connections. }
  ...
  CONNECT_REFCOUNT = $40;
  CONNECT_REDIRECT = $80;
  CONNECT_LOCALDRIVE = $100;
  CONNECT_CURRENT_MEDIA = $200;
...
function UpdateICMRegKeyA; external user32 name 'UpdateICMRegKeyA';
function UpdateICMRegKeyW; external user32 name 'UpdateICMRegKeyW';
function UpdateICMRegKey; external user32 name 'UpdateICMRegKeyA';
