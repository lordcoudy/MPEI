...
function ThreadFuncB(var dwParam:dword):integer; stdcall;
var i:integer;
begin
  while flaga do
    begin
...
function ThreadFuncC(var dwParam:dword):integer; stdcall;
var a,b:byte;
begin
  while flaga do
    begin
    ...
    wm_create: {Органы управления создаются при создании главного окна}
      begin
        ...
        CreateWindowEx(WS_EX_CLIENTEDGE,
                   ...
                   ws_visible or ws_child or ws_border  or ws_vscroll or LBS_Notify,
                   160,50,
                   rect.left+170,rect.bottom-60,
                   hwnd,
                   list, //list
                   hInstance,
                   nil);
        ...
        CreateWindowEx(WS_EX_CLIENTEDGE, // Утопленная рамка
                   'button',
                   'Запуск',
                   ws_visible or ws_tabstop or ws_child or ws_border,
                   50, 20,
                   80, 25,
                   hwnd,
                   start,
              ...
              begin
                if(hThreadB=0) and (hThreadC=0) then
                  begin
                    ...
                    hThreadB:=CreateThread(nil, 
                            0, 
                            @ThreadFuncB, 
                            nil, 
                            0, 
                            idThreadB);
                    hThreadC:=CreateThread(nil, 
                            0, 
                            @ThreadFuncC, 
                            nil,
                            0,
