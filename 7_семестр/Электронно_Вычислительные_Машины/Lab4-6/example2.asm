...
;«Эта программа выводит в защищенном режиме скан-коды
;клавиш и состояние переключающихся клавиш. При нажатии клавиши 'Esc'
;возникает исключение и отображается информация об этом исключении».
CODESEG
; ------------------------------------
