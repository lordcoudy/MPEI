        ...
        case 5:
            {
                ...
                MPI_Recv(cc, 3*batchSize, MPI_INT, 8, 17, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
                std::cout << "Rank 5. Received!" << std::endl;
                ...
                // 4
                MPI_Send(aa , batchSize, MPI_INT, 8, 18, MPI_COMM_WORLD);
                // 1
                MPI_Recv(aa, batchSize, MPI_INT, 2, 7, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
                MPI_Send(aa , batchSize, MPI_INT, 8, 19, MPI_COMM_WORLD);
                // 3
                MPI_Recv(aa, batchSize, MPI_INT, 4, 16, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
                MPI_Send(aa , batchSize, MPI_INT, 8, 20, MPI_COMM_WORLD);
        ...
        case 7:
            {
                ...
                MPI_Recv(cc, 3*batchSize, MPI_INT, 8, 28, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
                std::cout << "Rank 7. Received!" << std::endl;
                ...
                // 6
                MPI_Send(aa , batchSize, MPI_INT, 8, 29, MPI_COMM_WORLD);
                // 5
                MPI_Recv(aa, batchSize, MPI_INT, 6, 26, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
                MPI_Send(aa , batchSize, MPI_INT, 8, 30, MPI_COMM_WORLD);
                // 2
                MPI_Recv(aa, batchSize, MPI_INT, 6, 27, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
                MPI_Send(aa , batchSize, MPI_INT, 8, 31, MPI_COMM_WORLD);
